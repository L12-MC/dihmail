...
echo echo   Network: http://YOUR-IP:5000
echo echo.
...
echo.
echo To deploy:
echo   1. Copy entire '%DEPLOY_FOLDER%' folder to your server
echo   2. Run 'start_server.bat' on the server
echo   3. Access from browser at http://SERVER-IP:5000
echo.
